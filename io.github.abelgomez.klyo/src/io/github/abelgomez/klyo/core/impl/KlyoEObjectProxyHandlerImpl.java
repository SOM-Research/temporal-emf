...
import io.github.abelgomez.klyo.estores.impl.NullEStoreImpl;
import net.sf.cglib.proxy.MethodInterceptor;
import net.sf.cglib.proxy.MethodProxy;

public class KlyoEObjectProxyHandlerImpl extends MinimalEStoreEObjectImpl implements MethodInterceptor, KlyoInternalEObject {
	...
	public void klyoSetResource(Internal resource) {
		if (resource instanceof KlyoResource) {
			KlyoResource klyoResource = (KlyoResource) resource;
			this.klyoResource = klyoResource;
			this.eStore = klyoResource.eStore();
