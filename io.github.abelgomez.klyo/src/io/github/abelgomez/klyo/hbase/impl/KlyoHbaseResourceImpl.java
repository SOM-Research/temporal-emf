 ...
 ******************************************************************************/
package io.github.abelgomez.klyo.hbase.impl;
...
import io.github.abelgomez.klyo.core.exceptions.InvalidOptionsException;
...
public class KlyoHbaseResourceImpl extends ResourceImpl implements KlyoResource {
	 ...
	 * 
	 */
	protected final class DummyRootEObject extends KlyoEObjectImpl {
	...
	public String getURIFragment(EObject eObject) {
		if (eObject.eResource() != this) {
			...
			// Try to adapt as a KlyoEObject and return the ID
			KlyoEObject klyoEObject = KlyoEObjectAdapterFactoryImpl.getAdapter(eObject, KlyoEObject.class);
			if (klyoEObject != null) {
				return (klyoEObject.klyoId());
			}
		}
	...
	protected class ResourceContentsEStoreEList extends EStoreEObjectImpl.EStoreEList<EObject> {
		...
		public Object getNotifier() {
			return KlyoHbaseResourceImpl.this;
		}
		...
		protected boolean isNotificationRequired() {
			return KlyoHbaseResourceImpl.this.eNotificationRequired();
		}
		...
		public NotificationChain inverseAdd(EObject object, NotificationChain notifications) {
			...
			notifications = eObject.eSetResource(KlyoHbaseResourceImpl.this, notifications);
			KlyoHbaseResourceImpl.this.attached(eObject);
		...
		public NotificationChain inverseRemove(EObject object, NotificationChain notifications) {
			InternalEObject eObject = (InternalEObject) object;
			if (KlyoHbaseResourceImpl.this.isLoaded || unloadingContents != null) {
				KlyoHbaseResourceImpl.this.detached(eObject);
			}
		...
		protected void loaded() {
			if (!KlyoHbaseResourceImpl.this.isLoaded()) {
				Notification notification = KlyoHbaseResourceImpl.this.setLoaded(true);
				if (notification != null) {
					KlyoHbaseResourceImpl.this.eNotify(notification);
				}
			}
		}
	...
	public static void shutdownWithoutUnload(KlyoHbaseResourceImpl resource) throws IOException {
		resource.shutdown();
	}
}
