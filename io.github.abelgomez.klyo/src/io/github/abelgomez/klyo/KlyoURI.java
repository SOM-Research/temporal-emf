...
public class KlyoURI extends URI {

	private static final String FILE_SCHEME = "file";

	public static final String KLYO_HBASE_SCHEME = "klyo-hbase";
	
	protected URI internalUri;
	
	protected KlyoURI(int hashCode, URI internalUri) {
		super(hashCode);
		this.internalUri = internalUri;
	}

	public static URI createKlyoURI(URI uri) {
		if (KLYO_HBASE_SCHEME.equals(uri.scheme())) {
			return new KlyoURI(uri.hashCode(), uri);
		} else {
			throw new IllegalArgumentException(MessageFormat.format("Unsupported URI type {0}", uri.toString()));
		}
	}
	
	public static URI createKlyoHBaseURI(String authority, String table) {
		URI uri = URI.createHierarchicalURI(
				KlyoURI.KLYO_HBASE_SCHEME, 
				authority,
				null,
				new String[] { table },
				null,
