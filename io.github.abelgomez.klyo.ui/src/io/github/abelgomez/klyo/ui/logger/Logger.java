 ...
 *******************************************************************************/
package io.github.abelgomez.klyo.ui.logger;
...
public class Logger {
	...
	private static class OsgiLogger implements ILogger {
	    ...
	    private ILog log = KlyoPlugin.getDefault().getLog();    
	    
	    @Override
		public void log(int severity, Throwable e) {
	        log.log(new Status(severity, KlyoPlugin.PLUGIN_ID,
	        		e.getMessage() != null ? e.getMessage() : e.toString(), e));
	    }

	    @Override
		public void log(int severity, String msg, Throwable e) {
	    	log.log(new Status(severity, KlyoPlugin.PLUGIN_ID, msg, e));
	    }
	    
	    @Override
		public void log(int severity, String msg) {
	        log.log(new Status(severity, KlyoPlugin.PLUGIN_ID, msg, null));
	    }
	}
