 ...
 * @author abelgomez
 */
public class KlyoImporter extends ModelImporter {
	
	public static final String IMPORTER_ID = KlyoImporter.class.getName();
	...
	protected void adjustGenModel(Monitor monitor) {
		...
		KlyoMigratorUtil.adjustGenModel(genModel);
	}
