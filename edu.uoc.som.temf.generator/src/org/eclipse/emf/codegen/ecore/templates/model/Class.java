...
public class Class
{
  ...
  protected final String TEXT_447 = NL + "\t/**" + NL + "\t * Returns the value of the '<em><b>";
  protected final String TEXT_448 = " at the given instant." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the value of the '<em>";
  protected final String TEXT_449 = " at the given instant." + NL + "\t * @see #";
  protected final String TEXT_450 = "()" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_451 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_452 = NL + "\t * ";
  protected final String TEXT_453 = NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_454 = NL + "\t@Deprecated";
  protected final String TEXT_455 = NL + "\t";
  protected final String TEXT_456 = "At(";
  protected final String TEXT_457 = " instant);" + NL;
  protected final String TEXT_458 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_459 = NL + "\t@Override";
  protected final String TEXT_460 = NL + "\tpublic ";
  protected final String TEXT_461 = " instant)" + NL + "\t{";
  protected final String TEXT_462 = NL + "\t\treturn ";
  protected final String TEXT_463 = ")eGetAt(instant, ";
  protected final String TEXT_464 = NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_465 = NL + "\t}" + NL;
  protected final String TEXT_466 = NL + "\t/**" + NL + "\t * Returns whether the value of the '{@link ";
  protected final String TEXT_467 = " is set at the given instant." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return whether the value of the '<em>";
  protected final String TEXT_468 = " is set at the given instant." + NL + "\t * @see #isSet";
  protected final String TEXT_469 = NL + "\tboolean isSet";
  protected final String TEXT_470 = NL + "\tpublic boolean isSet";
  protected final String TEXT_471 = NL + "\t\treturn eIsSetAt(instant, ";
  protected final String TEXT_472 = " in the given time span." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the value of the '<em>";
  protected final String TEXT_473 = " in the given time span." + NL + "\t * @see #";
  protected final String TEXT_474 = "<";
  protected final String TEXT_475 = "> ";
  protected final String TEXT_476 = "AllBetween(";
  protected final String TEXT_477 = " start, ";
  protected final String TEXT_478 = " end);" + NL;
  protected final String TEXT_479 = NL + "\t@SuppressWarnings({ \"unchecked\", \"rawtypes\" })";
  protected final String TEXT_480 = " end)" + NL + "\t{";
  protected final String TEXT_481 = ")eGetAllBetween(start, end, ";
  protected final String TEXT_482 = NL + "\t/**" + NL + "\t * The cached validation expression for the '{@link #";
  protected final String TEXT_483 = ") <em>";
  protected final String TEXT_484 = "</em>}' invariant operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
  protected final String TEXT_485 = "__EEXPRESSION = \"";
  protected final String TEXT_486 = NL + "\t/**" + NL + "\t * The cached invocation delegate for the '{@link #";
  protected final String TEXT_487 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
  protected final String TEXT_488 = ".Internal.InvocationDelegate ";
  protected final String TEXT_489 = "__EINVOCATION_DELEGATE = ((";
  protected final String TEXT_490 = ").getInvocationDelegate();" + NL;
  protected final String TEXT_491 = NL + "\t/**";
  protected final String TEXT_492 = NL + "\t * <!-- begin-model-doc -->";
  protected final String TEXT_493 = NL + "\t * @param ";
  protected final String TEXT_494 = NL + "\t *   ";
  protected final String TEXT_495 = NL + "\t{";
  protected final String TEXT_496 = NL + "\t\treturn" + NL + "\t\t\t";
  protected final String TEXT_497 = ".validate" + NL + "\t\t\t\t(";
  protected final String TEXT_498 = "," + NL + "\t\t\t\t this," + NL + "\t\t\t\t ";
  ...
  protected final String TEXT_504 = ".ERROR," + NL + "\t\t\t\t ";
  protected final String TEXT_505 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t ";
  protected final String TEXT_506 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// -> specify the condition that violates the invariant" + NL + "\t\t// -> verify the details of the diagnostic, including severity and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_507 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_508 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_509 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_510 = ".ERROR," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_511 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_512 = "," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_513 = ".INSTANCE.getString(\"_UI_GenericInvariant_diagnostic\", new Object[] { \"";
  protected final String TEXT_514 = "\", ";
  protected final String TEXT_515 = ".getObjectLabel(this, ";
  protected final String TEXT_516 = ") }),";
  protected final String TEXT_517 = NL + "\t\t\t\t\t\t new Object [] { this }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_518 = NL + "\t\ttry" + NL + "\t\t{";
  protected final String TEXT_519 = "__EINVOCATION_DELEGATE.dynamicInvoke(this, ";
  protected final String TEXT_520 = ".UnmodifiableEList<Object>(";
  protected final String TEXT_521 = "null";
  protected final String TEXT_522 = NL + "\t\t\treturn ";
  protected final String TEXT_523 = NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_524 = " ite)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_525 = "(ite);" + NL + "\t\t}";
  ...
  protected final String TEXT_527 = " eInverseAdd(";
  protected final String TEXT_528 = " otherEnd, int featureID, ";
  protected final String TEXT_529 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_530 = ")" + NL + "\t\t{";
  protected final String TEXT_531 = NL + "\t\t\tcase ";
  protected final String TEXT_532 = ":";
  protected final String TEXT_533 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_534 = ".InternalMapView";
  protected final String TEXT_535 = "()).eMap()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_536 = NL + "\t\t\t\treturn (";
  protected final String TEXT_537 = "()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_538 = NL + "\t\t\t\tif (eInternalContainer() != null)" + NL + "\t\t\t\t\tmsgs = eBasicRemoveFromContainer(msgs);";
  protected final String TEXT_539 = NL + "\t\t\t\treturn basicSet";
  protected final String TEXT_540 = ")otherEnd, msgs);";
  protected final String TEXT_541 = NL + "\t\t\t\treturn eBasicSetContainer(otherEnd, ";
  protected final String TEXT_542 = NL + "\t\t\t\tif (";
  protected final String TEXT_543 = NL + "\t\t\t\t\tmsgs = ";
  protected final String TEXT_544 = NL + "\t\t\tdefault:";
  protected final String TEXT_545 = "\t\treturn super.eInverseAdd(otherEnd, featureID, msgs);";
  protected final String TEXT_546 = "\t\treturn eDynamicInverseAdd(otherEnd, featureID, msgs);";
  protected final String TEXT_547 = " eInverseRemove(";
  protected final String TEXT_548 = "()).eMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_549 = ".Internal.Wrapper)";
  protected final String TEXT_550 = "()).featureMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_551 = "()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_552 = NL + "\t\t\t\treturn eBasicSetContainer(null, ";
  protected final String TEXT_553 = NL + "\t\t\t\treturn basicUnset";
  protected final String TEXT_554 = "(msgs);";
  protected final String TEXT_555 = "(null, msgs);";
  protected final String TEXT_556 = "\t\treturn super.eInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_557 = "\t\treturn eDynamicInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_558 = " eBasicRemoveFromContainerFeature(";
  protected final String TEXT_559 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (eContainerFeatureID()";
  protected final String TEXT_560 = ":" + NL + "\t\t\t\treturn eInternalContainer().eInverseRemove(this, ";
  protected final String TEXT_561 = "\t\treturn super.eBasicRemoveFromContainerFeature(msgs);";
  protected final String TEXT_562 = "\t\treturn eDynamicBasicRemoveFromContainer(msgs);";
  protected final String TEXT_563 = NL + "\tpublic Object eGet(int featureID, boolean resolve, boolean coreType)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_564 = NL + "\t\t\t\treturn ";
  protected final String TEXT_565 = "() ? Boolean.TRUE : Boolean.FALSE;";
  protected final String TEXT_566 = NL + "\t\t\t\treturn new ";
  protected final String TEXT_567 = "());";
  protected final String TEXT_568 = NL + "\t\t\t\tif (resolve) return ";
  protected final String TEXT_569 = "();" + NL + "\t\t\t\treturn basicGet";
  protected final String TEXT_570 = NL + "\t\t\t\tif (coreType) return ((";
  protected final String TEXT_571 = "()).eMap();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_572 = NL + "\t\t\t\tif (coreType) return ";
  protected final String TEXT_573 = "();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_574 = "().map();";
  protected final String TEXT_575 = "()).featureMap();" + NL + "\t\t\t\treturn ";
  protected final String TEXT_576 = "();" + NL + "\t\t\t\treturn ((";
  protected final String TEXT_577 = "()).getWrapper();";
  protected final String TEXT_578 = "\t\treturn super.eGet(featureID, resolve, coreType);";
  protected final String TEXT_579 = "\t\treturn eDynamicGet(featureID, resolve, coreType);";
  protected final String TEXT_580 = NL + "\tpublic void eSet(int featureID, Object newValue)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_581 = NL + "\t\t\t\t((";
  protected final String TEXT_582 = "()).featureMap()).set(newValue);";
  protected final String TEXT_583 = "()).set(newValue);";
  protected final String TEXT_584 = ".Setting)((";
  protected final String TEXT_585 = "()).eMap()).set(newValue);";
  protected final String TEXT_586 = ".Setting)";
  protected final String TEXT_587 = "().clear();" + NL + "\t\t\t\t";
  protected final String TEXT_588 = "().addAll((";
  protected final String TEXT_589 = "<? extends ";
  protected final String TEXT_590 = ">";
  protected final String TEXT_591 = ")newValue);";
  protected final String TEXT_592 = NL + "\t\t\t\tset";
  protected final String TEXT_593 = "(((";
  protected final String TEXT_594 = ")newValue).";
  protected final String TEXT_595 = "newValue);";
  protected final String TEXT_596 = NL + "\t\t\t\treturn;";
  protected final String TEXT_597 = "\t\tsuper.eSet(featureID, newValue);";
  protected final String TEXT_598 = "\t\teDynamicSet(featureID, newValue);";
  protected final String TEXT_599 = NL + "\tpublic void eUnset(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_600 = "()).featureMap().clear();";
  protected final String TEXT_601 = "().clear();";
  protected final String TEXT_602 = NL + "\t\t\t\tunset";
  protected final String TEXT_603 = ")null);";
  protected final String TEXT_604 = "\t\tsuper.eUnset(featureID);";
  protected final String TEXT_605 = "\t\teDynamicUnset(featureID);";
  protected final String TEXT_606 = NL + "\tpublic boolean eIsSet(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_607 = NL + "\t\t\t\treturn isSet";
  protected final String TEXT_608 = NL + "\t\t\t\treturn !((";
  protected final String TEXT_609 = "()).featureMap().isEmpty();";
  protected final String TEXT_610 = " != null && !";
  protected final String TEXT_611 = ".featureMap().isEmpty();";
  protected final String TEXT_612 = ".isEmpty();";
  protected final String TEXT_613 = ");" + NL + "\t\t\t\treturn ";
  protected final String TEXT_614 = NL + "\t\t\t\treturn !";
  protected final String TEXT_615 = "().isEmpty();";
  protected final String TEXT_616 = " != null;";
  protected final String TEXT_617 = NL + "\t\t\t\treturn eVirtualGet(";
  protected final String TEXT_618 = ") != null;";
  protected final String TEXT_619 = NL + "\t\t\t\treturn basicGet";
  protected final String TEXT_620 = "() != null;";
  protected final String TEXT_621 = "_EFLAG) != 0) != ";
  protected final String TEXT_622 = "_EFLAG) != ";
  ...
  protected final String TEXT_628 = "\t\treturn super.eIsSet(featureID);";
  protected final String TEXT_629 = "\t\treturn eDynamicIsSet(featureID);";
  protected final String TEXT_630 = NL + "\tpublic int eBaseStructuralFeatureID(int derivedFeatureID, Class";
  protected final String TEXT_631 = " baseClass)" + NL + "\t{";
  protected final String TEXT_632 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_633 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (derivedFeatureID";
  protected final String TEXT_634 = NL + "\t\t\t\tcase ";
  protected final String TEXT_635 = ": return ";
  protected final String TEXT_636 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_637 = NL + "\t\treturn super.eBaseStructuralFeatureID(derivedFeatureID, baseClass);" + NL + "\t}";
  protected final String TEXT_638 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_639 = NL + "\tpublic int eDerivedStructuralFeatureID(int baseFeatureID, Class";
  protected final String TEXT_640 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_641 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID";
  protected final String TEXT_642 = NL + "\t\treturn super.eDerivedStructuralFeatureID(baseFeatureID, baseClass);" + NL + "\t}" + NL;
  protected final String TEXT_643 = NL + "\tpublic int eDerivedOperationID(int baseOperationID, Class";
  protected final String TEXT_644 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseOperationID)" + NL + "\t\t\t{";
  protected final String TEXT_645 = NL + "\t\t\t\tdefault: return super.eDerivedOperationID(baseOperationID, baseClass);" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_646 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseOperationID";
  protected final String TEXT_647 = NL + "\t\treturn super.eDerivedOperationID(baseOperationID, baseClass);" + NL + "\t}" + NL;
  protected final String TEXT_648 = NL + "\tprotected Object[] eVirtualValues()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_649 = ";" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_650 = NL + "\tprotected void eSetVirtualValues(Object[] newValues)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_651 = " = newValues;" + NL + "\t}" + NL;
  protected final String TEXT_652 = NL + "\tprotected int eVirtualIndexBits(int offset)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_653 = " :" + NL + "\t\t\t\treturn ";
  protected final String TEXT_654 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_655 = NL + "\tprotected void eSetVirtualIndexBits(int offset, int newIndexBits)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_656 = " :" + NL + "\t\t\t\t";
  protected final String TEXT_657 = " = newIndexBits;" + NL + "\t\t\t\tbreak;";
  protected final String TEXT_658 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_659 = NL + "\t@SuppressWarnings(";
  protected final String TEXT_660 = "\"unchecked\"";
  protected final String TEXT_661 = "{\"rawtypes\", \"unchecked\" }";
  protected final String TEXT_662 = NL + "\tpublic Object eInvoke(int operationID, ";
  protected final String TEXT_663 = " arguments) throws ";
  protected final String TEXT_664 = NL + "\t{" + NL + "\t\tswitch (operationID";
  protected final String TEXT_665 = NL + "\t\t\t\ttry" + NL + "\t\t\t\t{";
  protected final String TEXT_666 = "arguments.get(";
  protected final String TEXT_667 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_668 = "return null;";
  protected final String TEXT_669 = "return ";
  protected final String TEXT_670 = NL + "\t\t\t\t}" + NL + "\t\t\t\tcatch (";
  protected final String TEXT_671 = " throwable)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tthrow new ";
  protected final String TEXT_672 = "(throwable);" + NL + "\t\t\t\t}";
  protected final String TEXT_673 = "\t\treturn super.eInvoke(operationID, arguments);";
  protected final String TEXT_674 = "\t\treturn eDynamicInvoke(operationID, arguments);";
  protected final String TEXT_675 = NL + "\tpublic String toString()" + NL + "\t{" + NL + "\t\tif (eIsProxy()) return super.toString();" + NL + "" + NL + "\t\t";
  protected final String TEXT_676 = " result = new ";
  protected final String TEXT_677 = "(super.toString());";
  protected final String TEXT_678 = NL + "\t\tresult.append(\" (";
  protected final String TEXT_679 = ": \");";
  protected final String TEXT_680 = NL + "\t\tresult.append(\", ";
  protected final String TEXT_681 = NL + "\t\tif (eVirtualIsSet(";
  protected final String TEXT_682 = ")) result.append(eVirtualGet(";
  protected final String TEXT_683 = ")); else result.append(\"<unset>\");";
  protected final String TEXT_684 = "_ESETFLAG) != 0";
  protected final String TEXT_685 = ") result.append((";
  protected final String TEXT_686 = "_EFLAG) != 0); else result.append(\"<unset>\");";
  protected final String TEXT_687 = ") result.append(";
  protected final String TEXT_688 = "_EFLAG_OFFSET]); else result.append(\"<unset>\");";
  protected final String TEXT_689 = "); else result.append(\"<unset>\");";
  protected final String TEXT_690 = NL + "\t\tresult.append(eVirtualGet(";
  protected final String TEXT_691 = NL + "\t\tresult.append((";
  protected final String TEXT_692 = "_EFLAG) != 0);";
  protected final String TEXT_693 = NL + "\t\tresult.append(";
  protected final String TEXT_694 = "_EFLAG_OFFSET]);";
  protected final String TEXT_695 = NL + "\t\tresult.append(')');" + NL + "\t\treturn result.toString();" + NL + "\t}" + NL;
  protected final String TEXT_696 = NL + "\tprotected int hash = -1;" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_697 = NL + "\tpublic int getHash()" + NL + "\t{" + NL + "\t\tif (hash == -1)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_698 = " theKey = getKey();" + NL + "\t\t\thash = (theKey == null ? 0 : theKey.hashCode());" + NL + "\t\t}" + NL + "\t\treturn hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_699 = NL + "\tpublic void setHash(int hash)" + NL + "\t{" + NL + "\t\tthis.hash = hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_700 = " getKey()" + NL + "\t{";
  protected final String TEXT_701 = "(getTypedKey());";
  protected final String TEXT_702 = NL + "\t\treturn getTypedKey();";
  protected final String TEXT_703 = NL + "\tpublic void setKey(";
  protected final String TEXT_704 = " key)" + NL + "\t{";
  protected final String TEXT_705 = NL + "\t\tgetTypedKey().addAll(";
  protected final String TEXT_706 = "key);";
  protected final String TEXT_707 = NL + "\t\tsetTypedKey(key);";
  protected final String TEXT_708 = NL + "\t\tsetTypedKey(((";
  protected final String TEXT_709 = ")key).";
  protected final String TEXT_710 = NL + "\t\tsetTypedKey((";
  protected final String TEXT_711 = ")key);";
  protected final String TEXT_712 = " getValue()" + NL + "\t{";
  protected final String TEXT_713 = "(getTypedValue());";
  protected final String TEXT_714 = NL + "\t\treturn getTypedValue();";
  protected final String TEXT_715 = " setValue(";
  protected final String TEXT_716 = " value)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_717 = " oldValue = getValue();";
  protected final String TEXT_718 = NL + "\t\tgetTypedValue().clear();" + NL + "\t\tgetTypedValue().addAll(";
  protected final String TEXT_719 = "value);";
  protected final String TEXT_720 = NL + "\t\tsetTypedValue(value);";
  protected final String TEXT_721 = NL + "\t\tsetTypedValue(((";
  protected final String TEXT_722 = ")value).";
  protected final String TEXT_723 = NL + "\t\tsetTypedValue((";
  protected final String TEXT_724 = ")value);";
  protected final String TEXT_725 = NL + "\t\treturn oldValue;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_726 = " getEMap()" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_727 = " container = eContainer();" + NL + "\t\treturn container == null ? null : (";
  protected final String TEXT_728 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL;
...
if (index != -1) { head = typeName.substring(0, index); tail = "<code>" + CodeGenUtil.xmlEscapeEncode(typeName.substring(index)) + "</code>"; }
    ...
    stringBuffer.append(genModel.getImportedName("java.time.Instant"));
    stringBuffer.append(TEXT_457);
    } else {
    if (genModel.useGenerics() && ((genFeature.isContainer() || genFeature.isResolveProxies()) && !genFeature.isListType() && genFeature.isUncheckedCast(genClass) || genFeature.isListType() && !genFeature.isFeatureMapType() && (genModel.isReflectiveDelegation() || genModel.isVirtualDelegation() || (genModel.isDynamicDelegation() && !genFeature.isVolatile())) || genFeature.isListDataType() && genFeature.hasDelegateFeature() || genFeature.isListType() && genFeature.hasSettingDelegate())) {
    stringBuffer.append(TEXT_458);
    }
    if (useInterfaceOverrideAnnotation && !genClass.isMapEntry() && !genFeature.isSuppressedGetVisibility()) {
    ...
    if (!isImplementation) {
    stringBuffer.append(TEXT_455);
    stringBuffer.append(genModel.getImportedName("java.util.SortedMap"));
    stringBuffer.append(TEXT_474);
    stringBuffer.append(genModel.getImportedName("java.util.Date"));
    stringBuffer.append(TEXT_195);
    stringBuffer.append(genFeature.getObjectType(genClass));
