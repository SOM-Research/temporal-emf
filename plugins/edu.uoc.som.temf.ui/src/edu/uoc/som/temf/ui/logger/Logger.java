 ...
 *******************************************************************************/
package edu.uoc.som.temf.ui.logger;
...
public class Logger {
	...
	private static class OsgiLogger implements ILogger {
	    ...
	    private ILog log = TEmfPlugin.getDefault().getLog();    
	    
	    @Override
		public void log(int severity, Throwable e) {
	        log.log(new Status(severity, TEmfPlugin.PLUGIN_ID,
	        		e.getMessage() != null ? e.getMessage() : e.toString(), e));
	    }

	    @Override
		public void log(int severity, String msg, Throwable e) {
	    	log.log(new Status(severity, TEmfPlugin.PLUGIN_ID, msg, e));
	    }
	    
	    @Override
		public void log(int severity, String msg) {
	        log.log(new Status(severity, TEmfPlugin.PLUGIN_ID, msg, null));
	    }
	}
