...
/**
 * A {@link TransientTStoreImpl} that belongs to a single {@link EObject} owner
 * 
 * @author agomez
 * 
 */
public class OwnedTransientTStoreImpl extends TransientTStoreImpl {

	protected EObject owner;

	public OwnedTransientTStoreImpl(EObject owner) {
		this.owner = owner;
	}
