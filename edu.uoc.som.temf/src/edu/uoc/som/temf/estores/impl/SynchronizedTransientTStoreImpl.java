 ...
 * 
 */
public class SynchronizedTransientTStoreImpl implements InternalEObject.EStore {
	...
	public class EStoreEntryKey {
		...
		private SynchronizedTransientTStoreImpl getOuterType() {
			return SynchronizedTransientTStoreImpl.this;
		}
